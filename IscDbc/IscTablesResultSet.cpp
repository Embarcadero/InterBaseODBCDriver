...
void IscTablesResultSet::getTables(const char * catalog, const char * schemaPattern, const char * tableNamePattern, int typeCount, const char * * types)
{
	...
	addString(pt, "' as varchar(255)) as table_cat,\n"									// 1
					  ...
					  "cast (tbl.rdb$relation_name as varchar(67)) as table_name,\n"	// 3
	...
	do
	{
			...
			&& !(tableNamePattern && *tableNamePattern) )
		{
			*ptSql = '\0';
			...
			addString(pt, "' as varchar(67)) as table_cat,\n"	        // 1
				    "cast (NULL as varchar(67)) as table_schem,\n"		// 2
					"cast (NULL as varchar(67)) as table_name,\n"		// 3
					"cast (NULL as varchar(67)) as table_type,\n"		// 4
					"cast (NULL as varchar(255)) as remarks\n"			// 5
