													   ...
													   const char * columnNamePattern)
{
	...
	addString(pt, "' as varchar(255)) as procedure_cat,\n"									// 1
				"\tcast (p.rdb$owner_name as varchar(67)) as procedure_schem,\n"		// 2
				"\tcast (pp.rdb$procedure_name as varchar(67)) as procedure_name,\n"	// 3
				"\tcast (pp.rdb$parameter_name as varchar(67)) as column_name,\n"		// 4
				"\tpp.rdb$parameter_type as column_type,\n"			// 5
				"\tf.rdb$field_type as data_type,\n"				// 6
				"\tcast (pp.rdb$procedure_name as varchar(67)) as type_name,\n"			// 7
